...
import { LuFolderGit2, LuArrowUpRight, LuArrowRight, LuNetwork } from "react-icons/lu";
...
export const AegisFooter = ({ project, nextProject }: AegisFooterProps) => {
      ...
      <div className="p-6 sm:p-8 rounded-xl border border-neutral-800 bg-[#070709] flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-neutral-800 hover:border-neutral-600 bg-neutral-900 text-neutral-200 text-xs font-mono tracking-wider transition-colors focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:outline-none cursor-pointer"
          >
