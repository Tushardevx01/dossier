...
const SECTIONS: NavSection[] = [
  ...
  { id: "event-flow", number: "04", label: "Event Flow" },
  { id: "rigor", number: "05", label: "Technical Rigor" },
  { id: "ai-pipeline", number: "06", label: "AI Pipeline" },
  { id: "challenges", number: "07", label: "Challenges" },
  { id: "solutions", number: "08", label: "Solutions" },
  { id: "decisions", number: "09", label: "Decisions" },
  { id: "safety-model", number: "10", label: "Safety Gate" },
  { id: "security", number: "11", label: "Security" },
  { id: "states", number: "12", label: "Incident States" },
  { id: "audit-trail", number: "13", label: "Audit Trail" },
  { id: "offline-rl", number: "14", label: "Offline RL" },
  { id: "chaos-testing", number: "15", label: "Chaos Testing" },
  { id: "results", number: "16", label: "Outcomes" },
  { id: "closed-loop", number: "17", label: "The Closed Loop" },
  { id: "philosophy", number: "18", label: "System Intent" },
  { id: "source", number: "19", label: "Source Code" },
];

export const AegisNavigator = () => {
