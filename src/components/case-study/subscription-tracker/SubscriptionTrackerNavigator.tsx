...
const SECTIONS: NavSection[] = [
  ...
  { id: "data-model", number: "04", label: "Data Model" },
  ...
  { id: "lifecycle", number: "09", label: "Lifecycle" },
  { id: "workflow", number: "10", label: "Workflow" },
  { id: "auth-flow", number: "11", label: "Auth Flow" },
  { id: "api-surface", number: "12", label: "API Surface" },
  { id: "server", number: "13", label: "Server Runtime" },
  { id: "security", number: "14", label: "Security Layer" },
  { id: "results", number: "15", label: "Measurable Results" },
  { id: "summary", number: "16", label: "System Summary" },
  { id: "source", number: "17", label: "Source & Demo" },
];

export const SubscriptionTrackerNavigator = () => {
      ...
      <div className="bg-neutral-950/80 backdrop-blur-md border border-neutral-800/80 rounded-xl p-4 font-mono">
        ...
        <div className="mt-4 pt-3 border-t border-neutral-800/80 flex items-center justify-between text-[11px] text-neutral-400">
          <div className="flex items-center gap-1.5">
            ...
            <span>EXPRESS // UPSTASH</span>
          </div>
          <span className="font-mono text-[10px] text-neutral-400">API ENG</span>
        </div>
      </div>
    </aside>
  );
