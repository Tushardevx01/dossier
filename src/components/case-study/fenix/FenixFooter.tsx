...
interface FenixFooterProps {
  project: Project;
  nextProject?: Project;
}

export const FenixFooter = ({ project, nextProject }: FenixFooterProps) => {
  return (
      ...
      <div className="p-6 sm:p-8 rounded-xl border border-neutral-800 bg-[#070709] flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1.5 max-w-xl">
          ...
          <p className="text-xs sm:text-sm text-neutral-400 font-sans leading-relaxed">
            Inspect the Clerk authentication flow, Stream Video client integration, server-side token provider, and dynamic meeting layout components on GitHub.
          </p>
        </div>
