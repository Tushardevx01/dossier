...
const SECTIONS: NavSection[] = [
  ...
  { id: "patient-flow", number: "04", label: "Patient Flow" },
  { id: "appointment-workflow", number: "05", label: "Appointment Flow" },
  { id: "challenges", number: "06", label: "Challenges" },
  { id: "rigor", number: "07", label: "Technical Rigor" },
  { id: "validation", number: "08", label: "Validation" },
  { id: "decisions", number: "09", label: "Decisions" },
  { id: "data-flow", number: "10", label: "Data Flow" },
  { id: "appointment-data-flow", number: "11", label: "State Mutators" },
  { id: "states", number: "12", label: "System States" },
  { id: "admin-flow", number: "13", label: "Admin Control" },
  { id: "observability", number: "14", label: "Observability" },
  { id: "results", number: "15", label: "Results" },
  { id: "evidence", number: "16", label: "Code Evidence" },
  { id: "final-system", number: "17", label: "Full System" },
  { id: "source", number: "18", label: "Source & Demo" },
];

export const CarePulseNavigator = () => {
